...
CPPFLAGS = -DNETCDF -DUWM_STATS -DUWM_MISC -DPNNL_STATS -DATEX
# CPPFLAGS = -DNETCDF -DHISCALE -DUWM_MISC
...
# FFLAGS = -w -fallow-argument-mismatch -fbacktrace -fcheck=all -Wall -Wextra -g -O0
FFLAGS = -w -fallow-argument-mismatch -O3
